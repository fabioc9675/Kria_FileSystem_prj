...
set psu_clock_init_data {
		...
		# 6 bit divider
		# PSU_CRL_APB_SDIO1_REF_CTRL_DIVISOR1                                             0x4

		# 6 bit divider
		# PSU_CRL_APB_SDIO1_REF_CTRL_DIVISOR0                                             0x2f
    ...
    #  usually an issue, but designers must be aware.)
		...
		# This register controls this reference clock
		#(OFFSET, MASK, VALUE)      (0XFF5E0070, 0x013F3F07U ,0x01042F00U)  */
    mask_write 0XFF5E0070 0x013F3F07 0x01042F00
...
set psu_peripherals_init_data {
    ...
    # : Supports only 4-bit SD Interface
		...
		#(OFFSET, MASK, VALUE)      (0XFF180320, 0x33840000U ,0x02800000U)  */
    mask_write 0XFF180320 0x33840000 0x02800000
		# : SD1 BASE CLOCK
		# Register : SD_CONFIG_REG1 @ 0XFF18031C</p>

		# Base Clock Frequency for SD Clock. This is the frequency of the xin_clk.
		# PSU_IOU_SLCR_SD_CONFIG_REG1_SD1_BASECLK                                         0x7
    ...
    # .
		...
		#(OFFSET, MASK, VALUE)      (0XFF18031C, 0x7FFE0000U ,0x03D00000U)  */
    mask_write 0XFF18031C 0x7FFE0000 0x03D00000
